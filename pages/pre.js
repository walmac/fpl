...
const Pre = (props) => {
  ...
  let bytes;
  const help = {
    text :'Acá podés hacer un plan de vuelo llenando todos los datos correspondientes. Los aeropuertos de salida y destino van en ódigo OACI de 4 letras. Si el panel de la firma no aparece apreta limpiar para reiniciarlo. Es un panel táctil donde podés poner tu firma para que aparezca en el PDF que generamos después..'
  } 
